...
draws_new %>%
  filter(states == "Massachusetts" | states == "Georgia") %>%
  ggplot(aes(fill = states, x = trump_share)) +
  geom_density() +
  facet_wrap(~states) +
  scale_fill_manual(values = c("salmon", "dodgerblue"))
